...
// widok rezerwacji dla trenera
@Getter
@Setter
@AllArgsConstructor
@Builder
public class ReservationCoachDTO {
    ...
    private Integer reservationClientExperience; // <- widzi poziom doświadczenia klienta
    // co rezerwuje-dane w ramach potwierdzenia
